...
export default function Dashboard() {
	...
	const snapshotDetails = isZh
		? "历史报告仅保存汇总，未保存逐条提问、回答和情感标签。切换到当前数据可查看采集明细。"
		: "Historical reports contain summaries only, without individual prompts, responses or sentiment labels. Switch to current data to view details.";
