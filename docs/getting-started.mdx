...
description: Choose the right GEOK setup path, then follow a dedicated guide for local or self-hosted deployment.
---
...
Deploy GEOK on your own VPS for recurring schedules and always-on tracking.
