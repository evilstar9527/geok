...
description: Solutions for common issues when setting up and running GEOK.
---
...
**Fix:** Open the provider connection again, complete the full sign-in flow (including any 2FA or confirmation steps), and wait for the checkmark to appear in the GEOK UI before closing the browser window.
...
Note: these control sign-in to the GEOK web app itself. They are separate from the Google / Gemini / AI Overview provider connections used for monitoring.
